...
public class JwtUtils {
    ...
    @Value("${basemodx.security.jwtSecret}")
    private String jwtSecret;

    @Value("${basemodx.security.jwtExpirationMs}")
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        return Jwts.builder()
                .setSubject((userPrincipal.getUniqueId()))
    ...
    public String getUniqueUserIdFromJwtToken(String token) {
